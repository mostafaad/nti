...
if(editForm){
    ...
    if(!myElement) editForm.innerHTML=`<div class="alert alert-danger"> Error in Loading</div>`
        ...
        editForm.innerHTML=`
        <div class="mb-3">
        <input class="form-control" value=${myElement.title}  name="title">
    </div>
    <div class="mb-3">
      <input class="form-control" value=${myElement.age} name="age">
  </div>
  <div class="mb-3">
        <textarea class="form-control textarea"  name="content" rows="3">${myElement.content}</textarea>
    </div>
    <div class="mb-3">
        <input class="form-control" value=${myElement.dueDate} name="dueDate" type="date">
    </div>
    <div class="mb-3">
